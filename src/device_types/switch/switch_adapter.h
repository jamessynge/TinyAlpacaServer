...
class SwitchAdapter : public DeviceImplBase {
 public:
  ...
  virtual bool GetCanWrite(int32_t switch_id) = 0;
  ...
  virtual StatusOr<bool> GetSwitch(int32_t switch_id) = 0;
  ...
  // In both cases the driver should save a local copy of the state which it
  // last set and return this through GetSwitch and GetSwitchValue.
  virtual StatusOr<double> GetSwitchValue(int32_t switch_id) = 0;
  ...
  // implemented.
  virtual double GetMinSwitchValue(int32_t switch_id) = 0;

  // Gets the maximum value of the specified switch device as a double. Must be
  // implemented.
  virtual double GetMaxSwitchValue(int32_t switch_id) = 0;
  ...
  virtual double GetSwitchStep(int32_t switch_id) = 0;
  ...
  virtual Status PutSetSwitch(int32_t switch_id, bool state) = 0;
  ...
  // value.
  virtual Status PutSetSwitchValue(int32_t switch_id, double value) = 0;

  // TODO(jamessynge): Add HandleSetSwitchName once storage of names has been
  // sorted out.
