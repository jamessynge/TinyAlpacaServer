...
// #include
// "experimental/users/jamessynge/tiny-alpaca-server/src/utils/logging.h"
// #include
...
//   if (true)
//     TAS_CHECK(true) << "An integer " << 1 << ", followed by a float "
//     << 3.14;
//   else
...
//   if (false) {
//   } else  // NOLINT: Checking the else behavior.
//     TAS_CHECK(false) << "An integer " << 1 << ", followed by a float "
//     << 3.14;
...
// void setup() {  // NOLINT
//   // Setup serial, wait for it to be ready so that our logging messages can
//   be
//   // read.
//   Serial.begin(9600);
