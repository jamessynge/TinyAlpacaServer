#ifndef TINY_ALPACA_SERVER_SRC_UTILS_COUNTING_BITBUCKET_H_
#define TINY_ALPACA_SERVER_SRC_UTILS_COUNTING_BITBUCKET_H_
...
#endif  // TINY_ALPACA_SERVER_SRC_UTILS_COUNTING_BITBUCKET_H_
