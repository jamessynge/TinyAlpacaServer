#ifndef TINY_ALPACA_SERVER_EXAMPLES_AM_WEATHERBOX_SRC_SERVER_H_
#define TINY_ALPACA_SERVER_EXAMPLES_AM_WEATHERBOX_SRC_SERVER_H_
...
#endif  // TINY_ALPACA_SERVER_EXAMPLES_AM_WEATHERBOX_SRC_SERVER_H_
